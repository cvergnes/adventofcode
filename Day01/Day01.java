     ...
     List<String> lines = Files.readAllLines(Path.of("Day01.input"));
        ...
        for (String line : lines) {
            ...
            if (direction.equals("R")) {
                // count multiples of 100 crossed when moving from prevNorm to prevNorm+value (exclusive of start, inclusive of end)
                crosses = Math.floorDiv(prevNorm + value, 100) - Math.floorDiv(prevNorm, 100);
                dial = prev + value;
            } else if (direction.equals("L")) {
                // moving left: count multiples of 100 crossed when moving from prevNorm-value to prevNorm (exclusive of start, inclusive of end)
